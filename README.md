...
1. Create a form to add new TODOs:
  ...
  - add a new todo to the list afteo
  r clicking the `Add` button;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://NicssLucik02.github.io/react_add-todo-form/) and add it to the PR description.
